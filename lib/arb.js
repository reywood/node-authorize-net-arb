...
AuthNetArb.prototype.getSubscriptionStatus = function(request, callback) {
    ...
    this._sendReceiveAndParse(refId, xml, "ARBGetSubscriptionStatusResponse", function(error, response) {
        if (error) {
            callback(error);
        } else {
            callback(_undefined, {
...
AuthNetArb.prototype.updateSubscription = function(request, callback) {
    ...
    this._sendReceiveAndParse(refId, xml, "ARBUpdateSubscriptionResponse", function(error, response) {
        if (error) {
            callback(error);
        } else {
            callback(_undefined, {
