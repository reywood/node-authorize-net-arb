...
var buildXmlObjectArray = function(obj, fieldPaths) {
    ...
    _.each(fieldPaths, function(fieldPath) {
        ...
        if (typeof value !== "undefined") {
            insertFieldXmlObject(xmlObjects, fieldPath, value);
        }
    });
...
var insertFieldXmlObject = function(xmlObjects, fieldPath, value) {
    if (fieldPath.indexOf(".") === -1) {
        ...
        insertFieldXmlObject(headXmlObject[fieldPathHead], fieldPathTail, value);
    }
};
